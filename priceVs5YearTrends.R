...
google_trends <- read.csv("~/PycharmProjects/fyp/data_preprocessers/history_pricesWithTrends.csv",header = T)
#View(google_trends)
head(google_trends)
par(mfrow=c(2,1))
plot.ts(google_trends$usd)
plot.ts(google_trends$trend)
